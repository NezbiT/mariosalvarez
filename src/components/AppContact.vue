      ...
      <div class="grid gap-12 lg:grid-cols-5">
        ...
        >
          <div class="grid gap-5 sm:grid-cols-2">
            <div>
              <label for="contact-name" class="mb-1.5 block text-sm font-medium text-industrial-700">
              ...
              <input
                ...
                class="w-full rounded-lg border border-industrial-300 px-4 py-2.5 text-industrial-900 placeholder:text-industrial-400 transition-all duration-200 focus:border-accent-500 focus:ring-2 focus:ring-accent-500/30 focus:scale-[1.01]"
              />
            </div>
            <div>
              <label for="contact-company" class="mb-1.5 block text-sm font-medium text-industrial-700">
          ...
          <div>
            <label for="contact-email" class="mb-1.5 block text-sm font-medium text-industrial-700">
            ...
            <input
              ...
              class="w-full rounded-lg border border-industrial-300 px-4 py-2.5 text-industrial-900 placeholder:text-industrial-400 focus:border-accent-500 focus:ring-1 focus:ring-accent-500"
            />
          </div>

          <div class="grid gap-5 sm:grid-cols-2">
            <div>
              <label for="contact-type" class="mb-1.5 block text-sm font-medium text-industrial-700">
                {{ t_ui.contact.projectTypeLabel }}
              </label>
              <select
                id="contact-type"
                v-model="form.projectType"
                class="w-full rounded-lg border border-industrial-300 px-4 py-2.5 text-industrial-900 transition-all duration-200 focus:border-accent-500 focus:ring-2 focus:ring-accent-500/30"
              >
            ...
            <div>
              <label for="contact-budget" class="mb-1.5 block text-sm font-medium text-industrial-700">
          ...
          <div>
            <label for="contact-message" class="mb-1.5 block text-sm font-medium text-industrial-700">
            ...
            <textarea
              ...
              class="w-full rounded-lg border border-industrial-300 px-4 py-2.5 text-industrial-900 placeholder:text-industrial-400 transition-all duration-200 focus:border-accent-500 focus:ring-2 focus:ring-accent-500/30 resize-y"
            />
          </div>
        ...
        <aside class="space-y-6">
          <div class="rounded-xl border border-industrial-200 bg-industrial-50 p-6 transition-all duration-300 hover:border-accent-300 hover:shadow-md">
            <h3 class="mb-4 text-lg font-semibold text-industrial-800">
          ...
          <div class="flex flex-col gap-3">
            <a
              ...
              class="inline-flex items-center gap-3 rounded-lg border border-industrial-200 px-4 py-3 text-industrial-700 transition-all duration-200 hover:-translate-y-0.5 hover:border-accent-500 hover:text-accent-600 hover:shadow-md"
            >
