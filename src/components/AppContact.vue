<!--
  Sección de contacto con formulario Formspree y enlaces a ZeroDigitX / redes.
-->
 ...
 * 2. Crear un formulario nuevo y copiar el endpoint
 * 3. Reemplazar FORMSPREE_ENDPOINT abajo con tu URL real
 * 4. Opcional: activar reCAPTCHA en el panel de Formspree
 */
  ...
  try {
    const response = await fetch(FORMSPREE_ENDPOINT, {
      ...
      body: JSON.stringify({
        ...
        _subject: `New contact from mariosalvarez.com — ${form.name}`,
      }),
    })
