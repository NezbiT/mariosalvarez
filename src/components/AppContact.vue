    ...
    <div class="mx-auto max-w-6xl">
      ...
      <div class="grid gap-12 lg:grid-cols-5">
        ...
        >
          ...
          <div class="grid gap-5 sm:grid-cols-2">
            <div>
              ...
              <select
                ...
                class="w-full rounded-lg border border-industrial-300 px-4 py-2.5 text-industrial-900 focus:border-accent-500 focus:ring-1 focus:ring-accent-500"
              >
          ...
          <div>
            ...
            <textarea
              ...
              class="w-full rounded-lg border border-industrial-300 px-4 py-2.5 text-industrial-900 placeholder:text-industrial-400 focus:border-accent-500 focus:ring-1 focus:ring-accent-500 resize-y"
            />
          </div>
          ...
          <button
            ...
            class="w-full sm:w-auto rounded-lg bg-accent-600 px-8 py-3 font-medium text-white hover:bg-accent-500 disabled:opacity-60 disabled:cursor-not-allowed transition-colors"
          >
        ...
        <aside class="lg:col-span-2 space-y-6">
          <div class="rounded-xl border border-industrial-200 bg-industrial-50 p-6">
          ...
          <div class="flex flex-col gap-3">
            <a
              ...
              class="inline-flex items-center gap-3 rounded-lg border border-industrial-200 px-4 py-3 text-industrial-700 hover:border-accent-500 hover:text-accent-600 transition-colors"
            >
