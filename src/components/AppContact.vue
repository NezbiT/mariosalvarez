<!--
  Sección de contacto: ZeroDigitX + redes sociales (sin formulario).
-->
...
const socialLinkClass =
  'theme-aside-card inline-flex items-center gap-3 rounded-lg px-4 py-3 text-theme-secondary transition-all duration-200 hover:-translate-y-0.5 hover:border-accent-500 hover:text-accent-600 hover:shadow-md'
</script>
        ...
        <ScrollReveal :delay="100">
          <div class="theme-aside-card h-full rounded-xl p-6 transition-all duration-300 hover:border-accent-300 hover:shadow-md">
            ...
            <a
              ...
              class="inline-flex items-center gap-2 rounded-lg bg-accent-600 px-4 py-2.5 text-sm font-medium text-white hover:bg-accent-500 transition-colors"
            >
            ...
            <a
              ...
              class="mt-3 block text-sm font-medium text-accent-600 hover:underline"
            >
              {{ ZERODIGITX_PHONE_DISPLAY }}
            </a>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              class="mt-1 block text-xs text-theme-muted hover:text-accent-600"
            >
              zerodigitx.com
            </a>
          </div>
